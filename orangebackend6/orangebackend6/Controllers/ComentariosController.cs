...
namespace orangebackend6.Controllers
{
    ...
    public class ComentariosController : ControllerBase
    {
        ...
        [HttpGet("ActualizarEstadoComentarios/{idcomen}/{idest}")]
        public async Task<IActionResult> ActualizarEstadoComentarios([FromRoute] string idcomen, [FromRoute] string idest)
        {

            string Sentencia = "exec CambiarEstadoComments @idcoments, @estado";
